...
const Footer: React.FC = () => (
  <footer className="bg-[#141416]">
    <div className="max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row justify-between gap-12 border-b border-[#23242A]">
      {/* Left Section */}
    ...
    {/* Bottom Bar */}
    <div className="bg-[#23242A] py-4 px-8 flex flex-col md:flex-row items-center justify-between">
